            ...
            if TRAIN_MODE:
                ...
                for itr in range(N_EPISODES):
                    ...
                    for t in range(self.MAX_EPISODE_LEN):
                        ...
                        if np.random.rand(1) < self.EPSILON:
                            next_action[0] = self.env.action_space.sample()
                    ...
                    if agent_performance > self.TOPNOTCH:
                        ...
                        save_path = self.brain.saver.save(sess, '../models/problemA8/model2.ckpt')
                ...
                if SAVE_PLOT:
                    plt.savefig('../plots/problemA8/plot2-' + str(LEARNING_RATE) + '.eps', format='eps', dpi=50)
                else:
                    plt.show()
                ...
                self.brain.saver.restore(sess, '../models/problemA8/model2.ckpt')
                ...
                pd.DataFrame(performance_dict).to_csv('../outputs/problemA8-2-' + str(LEARNING_RATE) + '.csv')
